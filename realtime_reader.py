...
def dist_2_pts(x1, y1, x2, y2):
    # Get distance between of 2 points
...
def calibrate_gauge(cap, min_angle, max_angle, min_value, max_value, units):
    ...
    try:
        ...
        '''
        add the lines and labels to the circle
        '''
        for i in range(0, interval):
        ...
        '''
        Find and write all line on frame
        '''
        ...
        lines = cv2.HoughLinesP(image=dst2, rho=1, theta=np.pi / 180, threshold=100, minLineLength=minLineLength,
                                maxLineGap=0)  # you can set rho up to 3 to detect more lines, easier to get more then filter them out later
        ...
        # assumes the Second line is the best one
        ...
        '''
        Calculate angle of needle and value
        '''
        ...
        # for testing, print x, y angle and res
        # print x_angle
        # print y_angle
        # print res
        ...
        # if Detecting Circle of needle failed, Show pure video
